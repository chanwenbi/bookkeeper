...
/**
 * A <i>Seeker</i>'s job is to catch the <i>Gold Snitch<i>.
 */
public interface SnitchSeeker extends SubChannelDisconnectedListener {

    /**
     * Get the <i>snitch</i> that the given <i>topic</i> belongs to.
     *
     * @param topic
     *            Topic Name.
