...
public class Bookie extends BookieCriticalThread {
    ...
    private void checkEnvironment(ZooKeeper zk) throws BookieException, IOException {
        BookieAdmin.checkEnvironment(conf, zk, journalDirectory, ledgerDirsManager.getAllLedgerDirs(),
                indexDirsManager != ledgerDirsManager ? indexDirsManager.getAllLedgerDirs() : new ArrayList<File>());
    }
    ...
    private String getInstanceId(ZooKeeper zk) throws KeeperException,
        ...
        return BookieAdmin.getInstanceId(zk, conf);
    }
